...
mod tests {
    ...
    fn test_one_round_aes_encryption_of_a_64_bytes_plaintext() {
        let plaintext: [u8; 64] = [
            ...
            0x32, 0x43, 0xf6, 0xa8, 0x88, 0x5a, 0x30, 0x8d, 0x31, 0x31, 0x98, 0xa2, 0xe0, 0x37,
            0x07, 0x34,
            // 1 Start of Round from Appendix B - Cipher Example
            0xa4, 0x9c, 0x7f, 0xf2, 0x68, 0x9f, 0x35, 0x2b, 0x6b, 0x5b, 0xea, 0x43, 0x02, 0x6a,
            0x50, 0x49,
            // 2 Start of Round from Appendix B - Cipher Example
        ...
        let expected_ciphertext = [
            0x2f, 0x18, 0x94, 0xf3, 0xc8, 0x65, 0xcb, 0x3c, 0xe3, 0x0f, 0xc6, 0xf2, 0x21, 0xc9,
            0x69, 0x70,
            0x14, 0x3f, 0x31, 0x73, 0x3b, 0xac, 0x6a, 0x3e, 0x91, 0x1a, 0x4a, 0xe3, 0x67, 0x77,
            0xee, 0x73,
            0x52, 0x19, 0x7f, 0x0a, 0x47, 0xb1, 0x3f, 0x67, 0xeb, 0xa0, 0x1e, 0x88, 0x4d, 0x95,
            0x4d, 0x17,
            0x81, 0x3d, 0xc1, 0x4d, 0x9f, 0x8f, 0x94, 0xb9, 0x57, 0x90, 0x2f, 0x9c, 0x0d, 0xa8,
            0x39, 0x1d,
        ];
